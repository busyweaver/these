...
def trouverarbre(n,N,K,kf,to,noeuds):
    # print 'N%d' % N
    # print 'K%d' % K
    # print 'n!===%d' % n
    if N==0:
 ...
 #   print 'r%d' % r
 #   print 'm%d' % m
    tmp=trouvernoeuds(N,K,int(math.ceil(ab/float(kf[r][m]))),r,m,noeuds)
    maj_arbre(tmp,to)
